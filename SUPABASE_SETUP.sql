...
-- 3. TABELA DE SOLICITAÇÕES DE ACESSO (Opcional agora, mantida para histórico se desejar)
CREATE TABLE IF NOT EXISTS access_requests (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    created_at TIMESTAMPTZ DEFAULT now(),
    email TEXT UNIQUE NOT NULL,
    name TEXT,
    approved BOOLEAN DEFAULT true -- Padrão agora é aprovado
);
...
-- 7. POLÍTICAS PARA ACCESS_REQUESTS (Permissiva)
CREATE POLICY "Qualquer um pode ler dados de acesso" 
